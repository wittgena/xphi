...
from phase.proto.interface import IPhaseField, ICriticalDetector, ISystemRegime, IPhaseAtor
...
log = get_emitter("field.watcher", phase="BOOT")

@contract.watcher("field.watcher")
class FieldWatcher(ICriticalDetector):
    """
    @role: ∂Φ 임계 감시자
