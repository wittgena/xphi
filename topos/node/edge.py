...
class PhaseNode:
    """
    단순한 논리 유닛이 아닌, 위상 압력 하에서 구조적으로 성찰하고(Reflective)
    의도적으로 해체할 수 있는(Reversible) 에이전트입니다.
    """
    ...
    # --- 5. Recursive Rebinding (Optional Retry) ---
