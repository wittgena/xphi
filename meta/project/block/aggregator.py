# meta.project.block.aggregator
## @lineage: closure.project.block.aggregator
## @lineage: model.project.block.aggregator
## @lineage: project.block.aggregator
## @lineage: meta.ops.block.aggregator
import sys
import json
import argparse
...
from meta.project.block.emitter import main as emitter_main

log = get_emitter("emit.block")
