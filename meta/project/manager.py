...
## @lineage: closure.project.manager
## @lineage: model.project.manager
## @lineage: project.manager
## @lineage: meta.project.code.manager
import ast
import json
import argparse
import sys
...
from arch.project.logic.analyzer import LogicAnalyzer

CODE_ROOT = resolve_path("code")
log = get_emitter("project.manager")
