...
## @lineage: foldbox.actor.context.overlay
## @lineage: bridge.actor.context.overlay
## @lineage: center.actor.context.overlay
## @lineage: context.model.overlay
## @lineage: context.mode.overlay
## @lineage: context.overlay
## @lineage: arch.context.overlay
## @lineage: cognitive.context.overlay
...
from xphi.flow.xearch import Xor
