# meta.project.topic.bundle
## @lineage: foldbox.actor.context.topic.bundle
## @lineage: bridge.actor.context.topic.bundle
## @lineage: center.actor.context.topic.bundle
## @lineage: context.model.bundle
## @lineage: project.model.bundle
## @lineage: meta.project.model.bundle
import os
import sys
import re
import asyncio
...
class ProjectBundler(ProtoProjector[Path, Optional[Dict[str, Any]], Tuple[str, str], Dict[str, str]]):
