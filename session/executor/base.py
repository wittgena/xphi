# session.executor.base
from __future__ import annotations
import asyncio
from abc import ABC, abstractmethod
from typing import List, Dict, Optional, Any, Protocol
from dataclasses import dataclass
from phase.event.psi import PsiType, PsiEvent
from session.contract.proto.interface import IPhaseField, IBoundExecutor
...
class ParallelExecutor(BaseExecutor):
    """@phase.executor.parallel: ψ → {ψ₁..ψₙ} (local concurrency)"""
...
class AdaptiveExecutor(BaseExecutor):
    """@phase.executor.adaptive: ψ → strategy(select) → executor.execute"""
