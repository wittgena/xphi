# session.contract.arch.topos.proxy
import time
import uuid
import asyncio
import logging
...
from session.contract.proto.flow import ProtoFlow

log = get_emitter("inversion.proxy")

class NodeInversionProxy:
...
class DistributedNodePool:
    ...
    def get(self, role: str) -> NodeInversionProxy:
        try:
            ...
            return NodeInversionProxy(role, target_node_id, self.runtime, self.main_loop)
