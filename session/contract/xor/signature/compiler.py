# session.contract.xor.signature.compiler
import json
...
class SignatureCompiler:
    ...
    def _validate_phase(self, signature: signatureSignature):
...
class SignatureProjector:
    ...
    def project(self, signature: signatureSignature) -> Dict[str, Dict[str, Any]]:
        specs = {}
