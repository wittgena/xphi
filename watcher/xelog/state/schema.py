# watcher.xelog.state.schema
## @lineage: topos.state.edge
## @lineage: topos.xelog.topos.state.edge
...
## [A2A (Trustless Compute) - Request Schemas]
...
## [A2A (Trustless Compute) - Response Schemas]
...
## [D3Fi (Exchange & Clearing) - Request Schemas]
