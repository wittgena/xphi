...
from contract.proto.interface import IPhaseAtor, IPhaseField, IEventBus
from watcher.sphere.receptor.lens.trajectory import (
    Point, 
...
from watcher.sphere.container.scale.emitter import ScaleEmitter
