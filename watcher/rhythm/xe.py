...
"""
@origin.T0:
- Initial coherence gap produces primitive ψ signals.
- Attempted closure toward T0 repeatedly fails and generates a cancel–inversion loop that re-emits new ψ flows.
