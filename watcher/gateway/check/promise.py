# watcher.gateway.check.promise
## @lineage: gateway.check.promise
## @lineage: nexus.hub.manager
...
import logging
from watcher.gateway.policy.budget import Psi, Residue, ShiftDecision, TokenContext, TokenVerdict, AnyTokenPolicy
from watcher.gateway.policy.iam import SystemicRisk, ActionDirective, PolicyVerdict, AnySystemPolicy, RiskSeverity
from watcher.plane.emitter import get_emitter

log = get_emitter("manager.promise")
...
## Unified Governance Layer (텔레메트리 중앙집중화)
