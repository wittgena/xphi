...
from flow.phase import ToposFlow
...
class RemoteNodeProxy:
    ...
    async def _dispatch_async(self, flow: ToposFlow):
        try:
    ...
    def __call__(self, flow: ToposFlow):
...
class DistributedNodePool:
    ...
    def get(self, role: str) -> RemoteNodeProxy:
        try:
            ...
            return RemoteNodeProxy(role, target_node_id, self.runtime, self.main_loop)
