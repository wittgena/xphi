...
from kube.transcript import TranscriptEngine, Projector

log = get_logger("flow.deploy")
...
class FinalDeployFlow:
    ...
    def __init__(self, project_dir: str):
        ...
        self.validator = KubeFlowValidator()
    ...
    def run(self, task: Optional[str] = None):
        ...
        from flow.res.transcript import run_pipeline
