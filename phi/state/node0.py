...
import uuid
from contract.interface.pir import PsiSignal, PhaseInterpreter, AnchoredIR, AnchorFlow
...
class Node0State:
    ...
    def quarantine_collapse_log(self, collapse_log: List[PsiSignal]) -> List[PsiSignal]:
        """
