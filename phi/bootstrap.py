...
async def bootstrap(
    ...
    current_self = Path(find_current_self())
    print(f"current_self: {current_self}")
    for repo in repos: 
        repo_path = current_self / repo
    ...
    bootstrap_flow = AtorFlow(payload=topology_path, aspect="bootstrap")
