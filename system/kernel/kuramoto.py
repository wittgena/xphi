...
from bound.interface import IDynamicsKernel
from system.config import KernelConfig
from contract.registry import kernel_contract

@kernel_contract("kuramoto")
