...
from phase.contract.registry import registry, contract
...
from phase.contract.proto.interface import IDynamicsKernel

## 런타임에 동적으로 융합 커널(ResonanceKernel) 생성 및 레지스트리 등록
@contract.kernel("resonance")
class ResonanceKernel(IDynamicsKernel):
