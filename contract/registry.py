...
from contract.proto.col import Proto
...
class UnifiedRegistry:
    ...
    def __init__(self):
        ...
        self._bootstraps: Dict[str, List[Dict[str, Any]]] = defaultdict(list)
    ...
    @property
    def registered_bootstraps(self) -> Mapping[str, List[Dict[str, Any]]]:
    ...
    def register_bootstrap(self, group: str, module_fqn: str, args: Optional[List[str]] = None):
        self._bootstraps[group].append({
            "module_fqn": module_fqn, "args": args or []
        })
...
def bootstrap_contract(group: str, args: List[str] = None):
    def decorator(func: Callable):
        registry.register_bootstrap(group, func.__module__, args)
        return func
    return decorator
