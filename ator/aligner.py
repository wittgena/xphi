...
@ator_contract("file.writer")
class FileWriter(Align):
    """@flow: 내부의 ψ를 물리적 Φ(파일)로 투영"""
    def align(self, flow: AtorFlow, spec: Dict[str, Any]) -> Dict[str, Any]:
...
@ator_contract("http.probe.aligner")
...
@ator_contract("spec.projection.aligner")
