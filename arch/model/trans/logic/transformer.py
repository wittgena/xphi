# arch.model.trans.logic.transformer
## @lineage: arch.contract.trans.logic.transformer
## @lineage: arch.gov.trans.logic.transformer
## @lineage: arch.topos.trans.logic.transformer
