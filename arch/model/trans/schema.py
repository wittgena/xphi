# arch.model.trans.schema
## @lineage: arch.contract.trans.schema
## @lineage: arch.gov.trans.schema
## @lineage: arch.topos.trans.schema
## @lineage: arch.topos.node.trans.schema
