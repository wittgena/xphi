...
from flow.schema.base import Base
from flow.thought import ThCh
from plane.emitter import get_emitter

log = get_emitter("proto.lmp")

class ProgramMeta(type):
    def __call__(cls, *args, **kwargs):
        obj = cls.__new__(cls, *args, **kwargs)
        if isinstance(obj, cls):
            ProtoLMP._base_init(obj)
...
class ProtoLMP(Base, metaclass=ProgramMeta):
    signature = None
