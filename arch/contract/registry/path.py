...
from xphi.kernel.space.bind.resolver import find_current_self, load_bound, resolve_path as legacy_resolve
...
class PathRegistry:
    ...
    def lazy_sync(self):
        ...
        try:
            from xphi.kernel.space.bind.resolver import find_current_self, load_bound
    ...
    def resolve(self, name: str, start: Path | None = None) -> Path:
        ...
        from xphi.kernel.space.bind.resolver import resolve_path as legacy_resolve
