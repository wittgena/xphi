# arch.xor.sign.field
## @lineage: arch.xor.manifold.sign.field
...
_DEPRECATED_FIELD_ARGS = {
    ...
    "format": (
        "The 'format' argument in InputField/OutputField is deprecated and has no effect in spi. "
        "It will be removed in a future version."
    ),
    "parser": (
        "The 'parser' argument in InputField/OutputField is deprecated and has no effect in spi. "
        "It will be removed in a future version."
    ),
}
