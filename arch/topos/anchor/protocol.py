...
from phase.wasm.resolver.adapter import StateAdapter  # [NEW] Adapter Import
...
async def anchor_git_commit_async(
    ...
    # [CHANGED] 결정론적 해싱을 위해 RFC 8785 규격의 Canonical JSON 사용
    ...
    # [CHANGED] StateAdapter를 이용해 Rust WASM 구조체(Struct) 레이아웃에 완벽히 호환되는 Payload 빌드
