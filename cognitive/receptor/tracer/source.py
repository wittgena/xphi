# cognitive.receptor.tracer.source
...
from cognitive.receptor.topos import ReceptorTopos
from cognitive.receptor.tracer.trajectory import Point, WindowedTrajectory, DefaultBoundLensStrategy

class TracerSource(FileSystemEventHandler):
    """@desc: 물리적 파일 시스템의 변이를 감지하여 PhaseSurface에 이산적 틱(Tick)을 주입"""
    def __init__(self, surface: ReceptorTopos, loop: asyncio.AbstractEventLoop):
