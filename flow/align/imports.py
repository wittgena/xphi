...
from model.surface.aligner import FieldAligner, AlignRecord

emitter = get_emitter("sync.imports", phase="SYSTEM")
...
def main():
    ...
    aligner = ImportAligner(root_dir=args.repo, old_prefix=args.old, new_prefix=args.new)
