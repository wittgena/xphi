...
from contract.proto.trans import PhaseSpec, TransRule
from contract.proto.topos import LinkerNode, InversionNode, PhaseNode, NodeType
from flow.inversion.proxy import DistributedNodePool
from flow.inversion.runtime import InversionRuntime

log = get_emitter("inversion.organizer")
...
async def main():
    ...
    try:
        ...
        organizer = InversionOrganizer(pool)
        ...
        flow_controller = InversionRuntime(
            entry=entry_point,
            nodes=runtime_nodes,
