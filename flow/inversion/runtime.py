...
from contract.proto.trans import PhaseSpec, TransRule, NodeType
from contract.proto.topos import LinkerNode, InversionNode, PhaseNode, ResidueType

log = get_emitter("topos.runtime")

class InversionRuntime:
