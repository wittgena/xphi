...
class SchemeRunner:
    ...
    async def _run_case(self, title: str, target_func: str, payload: str, expected_success: bool):
        ...
        if result.success == expected_success:
            ...
            self.fail_count += 1
            self.last_failed_context.append(f"Function: {target_func} | Input: {payload[:50]}... | Error: {err_msg}")
