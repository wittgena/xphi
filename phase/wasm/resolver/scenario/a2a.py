...
class A2AScenarios(SchemeRunner):
    ...
    def _generate_signature(self, commit_dict: dict) -> str:
        """Ed25519 signature utility for deterministic consensus and proof generation."""
...
"""
    ...
    async def _test_a2a_ledger_inscription(self):
        ...
        await self._run_case("A2A: Inscribe Transaction for State Finality", "inscribe_actor", payload, expected_success=True)