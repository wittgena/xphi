...
log = logging.getLogger("transcript.meta")

# ==============================================================================
# [1] Meta-Bootstrapping Anchor: 자기 자신을 기동하기 위한 위상 정의
# meta.py 자체가 '일반 코드를 XPHI로 변환하는 단일 노드'로서 실행됩니다.
# ==============================================================================
XPHI = {
    "entry": "transcriptor",
    "nodes": {
