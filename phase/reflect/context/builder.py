# phase.reflect.context.builder
## @lineage: phase.runtime.builder
from typing import Callable, Dict, Any

from phase.reflect.context.assembler import ContextAssembler
...
class ContextBuilder:
    ...
    @classmethod
    def build(cls, interpreter, redis_client) -> ContextCoupler:
        engine = LLMEngine()
        ...
        worker = ContextWorker(engine, assembler)
        aggregator = KernelStateAggregator(interpreter, redis_client)
        
        return ContextCoupler(aggregator, worker)