# phase.pattern.code.bound.manager
import ast
import json
import argparse
import sys
...
from phase.pattern.lang.model import LangModel, NodeData, EdgeData, LoopEdgeData, PhaseGraphSchema
from bound.surface.emitter import get_emitter
from bound.resolver import resolve_path
from phase.pattern.code.logic.transformer import LogicTransformer
from phase.pattern.code.analyzer import CodeAnalyzer

CODE_ROOT = resolve_path("code")
log = get_emitter("code.analyzer")
...
def main():
    ...
    manager = BoundManager(args.repo)
    schema = manager.run()
