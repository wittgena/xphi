# phase.receptor.aura
## @lineage: cognitive.aura.receptor
## @lineage: cognitive.nerve.aura.receptor
import math
from dataclasses import dataclass, field
from typing import Any, Optional
from topos.bound.plane.emitter import get_emitter
from xphi.model.aura.psi import AuraPsi, AuraSignature
...
class AuraReceptor:
    ...
    def _rupture(self, trigger_residue: Any):
        """
        상전이(Phase Transition): 쌓인 텐션을 방출하고 상태를 붕괴시킵니다.
        """
