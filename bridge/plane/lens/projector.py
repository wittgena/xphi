...
from bridge.plane.lens.trajectory import (
    Point, 
...
from bridge.plane.lens.proactor import ScaleProactor
...
async def main():
    ...
    bus.subscribe(ScaleProactor("decision.praxis"))
