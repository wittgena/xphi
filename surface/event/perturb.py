...
from anchor.resolver import resolve_channel, resolve_pattern
from plane.emitter import get_emitter

class EventPerturb:
    """
    @role: Bound Elicitor / Surface perturb
    @desc:
    ...
    def __init__(self, redis_url: str = "redis://localhost:6379/0"):
        ...
        self.log = get_emitter("surface.perturbator", phase="xphi")
