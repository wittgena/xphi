...
from manifold.contract.registry import discover_modules
...
async def main():
    ...
    ## 3. 코어 시스템 Executor 생성
    ## DynamicsExecutor 내부에서 SystemBuilder.build(config_dict)가 호출되며 조립됨
