...
from bridge.interface.pir import PsiSignal
from bridge.interface.bus import AsyncEventBus
from bridge.interface.topos import IPhaseField, IPhaseAtor, IEventBus, PsiEvent, IDynamicsKernel
from bridge.rhythm import RhythmCoupler
...
class Evaluator:
    ...
    def evaluate(self, psi: PsiSignal, field: Field) -> str:
...
def to_event(psi: PsiSignal) -> PsiEvent:
